...
LOCK TABLES `cousine` WRITE;
/*!40000 ALTER TABLE `cousine` DISABLE KEYS */;
INSERT INTO `cousine` VALUES (1,'Chinese'),(2,'Pizza'),(3,'Vietnamese'),(4,'Sushi');
/*!40000 ALTER TABLE `cousine` ENABLE KEYS */;
UNLOCK TABLES;
